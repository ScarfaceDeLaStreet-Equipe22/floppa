...
public class SellerRepositoryTests
{
    ...
    public void givenExistingSeller_whenUpdating_thenOtherSellersAreNotUpdated()
    {
        ...
        assertNotEquals(foundFirstSeller.getBirthdate(), updatedBirthDate, "First Seller birthdate changed");
        assertNotEquals(foundFirstSeller.getEmail(), updatedEmail.getEmail(), "First Seller email changed");
        assertNotEquals(foundFirstSeller.getPhoneNumber(), updatedPhoneNumber.getNumero(), "First seller phone changed");
        ...
        assertNotEquals(foundLastSeller.getBirthdate(), updatedBirthDate, "Last Seller birthdate changed");
        assertNotEquals(foundLastSeller.getEmail(), updatedEmail.getEmail(), "Last Seller email changed");
        assertNotEquals(foundLastSeller.getPhoneNumber(), updatedPhoneNumber.getNumero(), "Last seller phone changed");
        assertNotEquals(foundLastSeller.getBio(), updatedBio, "Last seller bio changed");
    }
