...
class SellerRequestValidatorTest {
    ...
    public void givenNullName_whenValidatingRequest_thenThrowsMissingNameException() {
        //arrange
        SellerRequest requestWithNullName = new SellerRequest(null, "bio", "1995-01-01", "test@test.com", "18191234567");
    ...
    public void givenNullBio_whenValidatingRequest_thenThrowsMissingBioException() {
        //arrange
        SellerRequest requestWithNullBio = new SellerRequest("name", null, "1995-01-01", "test@test.com", "18191234567");
    ...
    public void givenNullBirthDate_whenValidatingRequest_thenThrowsMissingBirthDateException() {
        //arrange
        SellerRequest requestWithNullBirthDate = new SellerRequest("name", "bio", null, "test@test.com", "18191234567");
    ...
    public void givenNullEmail_whenValidatingRequest_thenThrowsMissingEmailException() {
        //arrange
        SellerRequest requestWithNullEmail = new SellerRequest("name", "bio", "1995-01-01", null, "18191234567");
    ...
    public void givenNullPhoneNumber_whenValidatingRequest_thenThrowsMissingPhoneNumberException() {
        //arrange
        SellerRequest requestWithNullPhoneNumber = new SellerRequest("name", "bio", "1995-01-01", "test@test.com", null);
    ...
    public void givenValidRequest_whenValidatingRequest_thenDoesNotThrowException() {
        //arrange
        SellerRequest validRequest = new SellerRequest("name", "bio", "1995-01-01", "test@test.com", "18191234567");
